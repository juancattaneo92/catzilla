...
function renderBuyerInfo(){
    ...
    image.style.backgroundImage = `url("images2/catzilla5.png")`
    image.style.backgroundSize = "cover"
    buyers.style.backgroundColor = "rgb(240, 159, 19)"
...
function renderCommunityInfo(){
    ...
    let image = document.getElementById("image-swap")
    image.style.backgroundImage = `url("images2/catzilla3.jpg")`
    community.style.backgroundColor = "rgb(240, 159, 19)"
